// <reference path="../Niveles/liz_in_wonderland.html" />
...
var game = (function () {
    ...
    function preloadImages() {
        for (var i = 1; i <= 8; i++) {
            ...
            evilImage.src = 'Imagenes/malo' + i + '.png';
            evilImages.animation[i - 1] = evilImage;
            var bossImage = new Image();
            bossImage.src = 'Imagenes/jefe' + i + '.png';
            bossImages.animation[i - 1] = bossImage;
        }
        evilImages.killed.src = 'Imagenes/malo_muerto.png';
        bossImages.killed.src = 'Imagenes/jefe_muerto.png';
        bgMain = new Image();
        bgMain.src = 'Imagenes/fondovertical.png';
        bgBoss = new Image();
        bgBoss.src = 'Imagenes/fondovertical_jefe.png';
        playerShotImage = new Image();
        playerShotImage.src = 'Imagenes/disparo_bueno.png';
        evilShotImage = new Image();
        evilShotImage.src = 'Imagenes/disparo_malo.png';
        playerKilledImage = new Image();
        playerKilledImage.src = 'Imagenes/bueno_muerto.png';
    ...
    function showCongratulations() { 
        ...
        location.href = "https://www.youtube.com/watch?v=vwvgt_h4F3Q";
        bufferctx.fillStyle = "rgb(204,50,153)";
        bufferctx.font = "bold 22px Arial";
        //bufferctx.fillText("La pesadilla aún continua", canvas.width / 2 - 200, canvas.height / 2 - 30);
